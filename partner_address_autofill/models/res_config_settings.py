...
class ResConfigSettings(models.TransientModel):
    ...
    # rcs_google_country = fields.Many2one('res.country', related="company_id.rcs_google_country" ,string="Search Perticular Country",readonly=False)
    rcs_google_country1 = fields.Many2many('res.country', related="company_id.rcs_google_country1" ,string="Search Perticular Country",readonly=False)
