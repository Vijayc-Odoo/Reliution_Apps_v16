...
class PaymentProvider(models.Model):
    ...
    paymob_secret_key = fields.Char("Paymob Secret Key", required_if_provider="paymob")
    paymob_api_key = fields.Char("Paymob API Key", required_if_provider="paymob")
    ...
    def match_countries(self, public_key, secret_key):
        ...
        if public_key and secret_key:
            ...
            if public_key_parts[0] not in [
                "egy",
                "omn",
                "are",
                "sau",
            ] or secret_key_parts[0] not in ["egy", "omn", "are", "sau"]:
